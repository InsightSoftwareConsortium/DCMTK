...
if(DCMTK_USE_FIND_PACKAGE)
  # Find TIFF
  if(DCMTK_WITH_TIFF)
    # When built as part of ITK, TIFF_*/JPEG_* hints point at ITK's internal
    # libraries whose include layout the stock Find modules cannot parse; use
    # the hints directly (as the PNG and ZLIB branches already do).
    ...
    if(NOT TIFF_FOUND OR NOT JPEG_FOUND)
      ...
      if(NOT (JPEG_INCLUDE_DIR AND JPEG_LIBRARY))
