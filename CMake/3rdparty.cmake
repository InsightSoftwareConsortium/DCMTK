...
if(DCMTK_USE_FIND_PACKAGE)
  # Find TIFF
  if(DCMTK_WITH_TIFF)
    # When consumed by a project that already provides TIFF/JPEG (e.g. ITK),
    # TIFF_LIBRARIES/JPEG_LIBRARIES are pre-set; only fall back to find_package
  ...
  if(DCMTK_WITH_PNG)
    ...
    if(PNG_FOUND)
      ...
      set(LIBPNG_LIBS ${PNG_LIBRARIES} ${LIBPNG_EXTRA_LIBS_STATIC})
    else()
  ...
  # Find zlib
  if(DCMTK_WITH_ZLIB)
    # find_package almost always finds the system zlib even when the consuming
    # project builds its own; honor a pre-set ZLIB_LIBRARIES first.
